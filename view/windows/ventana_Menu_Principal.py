...
"")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("./view/components/iconos/fondoPrincipalV2.jpg"))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./view/components/iconos/icono_Habitos_Salud.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./view/components/iconos/icono_logros-habitos.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./view/components/iconos/icons8-goals.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./view/components/iconos/icons8-comunidad.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./view/components/iconos/usuarios.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./view/components/iconos/icons-salir.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
